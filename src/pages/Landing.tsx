    ...
    <div className="min-h-screen bg-[#1E1E2F] text-[#F5F5F5] flex flex-col font-sans">
      ...
      <header className="px-8 py-6 flex justify-between items-center border-b border-[#3F3F5A]/30 relative z-20 bg-[#1E1E2F]/80 backdrop-blur-md">
        <div className="flex items-center gap-2">
          ...
          <span className="text-2xl font-extrabold text-[#F5F5F5] tracking-tight">
            {PROJECT_NAME}
          </span>
        </div>
        <Link
      ...
      <main className="flex-1 flex flex-col items-center justify-center pt-20 pb-8 px-4 text-center relative overflow-hidden">
        ...
        <div className="z-10 max-w-4xl mx-auto flex flex-col items-center">
          ...
          >
            Platform manajemen pemesanan ruangan kampus yang terintegrasi.
            Mudah, cepat, dan transparan untuk Mahasiswa, Dosen, dan Staf.
          </motion.p>
        ...
        <div
          id="fitur"
          className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-32 z-10 max-w-6xl w-full px-4"
        >
          {[
            {
            ...
            },
            {
              ...
              hoverColor:
                "hover:border-indigo-400/50 hover:shadow-indigo-400/10",
            },
          ].map((feature, index) => (
            <motion.div
              key={index}
                ...
                <div className="space-y-8">
                  <div className="flex gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-[#B4B4C8] leading-relaxed">
                        Sistem menggunakan enkripsi standar industri untuk
                        melindungi data pribadi mahasiswa dan staf.
                      </p>
                    </div>
                  </div>
                  <div className="flex gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-[#B4B4C8] leading-relaxed">
                        Terhubung langsung dengan database kampus untuk
                        sinkronisasi jadwal kuliah secara otomatis.
                      </p>
                    </div>
                  </div>
                </div>
      ...
      >
        <div className="max-w-6xl mx-auto px-8 grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
          ...
          <div>
            ...
            <ul className="space-y-4 text-[#B4B4C8]">
              <li>
                <Link
                  to="/"
                  onClick={() => trackClick("click_footer_beranda")}
              ...
              <li>
                <a
                  href="#fitur"
                  onClick={() => trackClick("click_footer_fitur")}
                  className="hover:text-indigo-400 transition-colors"
                >
                  Fitur
                </a>
          ...
          <div>
            <h4 className="font-bold text-[#F5F5F5] mb-6 text-lg">
              Bantuan Teknis
            </h4>
            <SupportEmailLink
              email={SUPPORT_EMAIL}
