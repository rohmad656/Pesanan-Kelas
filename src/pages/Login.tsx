...
export default function Login() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (err.code === 'custom/user-not-found') {
      ...
      } else if (err.code === 'custom/need-registration') {
        ...
        setError('Terlalu banyak percobaan. Akun Anda sementara dibekukan demi keamanan. Silakan tunggu beberapa menit atau hubungi Admin.');
  ...
  const handleGoogleLogin = async () => {
    ...
    try {
      ...
      } else if (err.code === 'auth/email-already-in-use-firestore') {
