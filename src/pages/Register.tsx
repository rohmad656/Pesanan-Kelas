...
export default function Register() {
  ...
  const isFormValid = identifier && !identifierError && whatsappNumber && !whatsappError && name && !isCheckingIdentifier && email && !emailError;
      ...
      >
        <div className="p-6 sm:p-10">
          <div className="text-center mb-8">
            ...
            <h1 className="text-2xl font-extrabold mb-2 tracking-tight">Lengkapi Profil</h1>
            ...
            <div className="space-y-1.5">
              ...
              <div className={cn(
                ...
                <Mail className={cn(
                  ...
                  !isCampusEmail ? "text-slate-500" : "group-focus-within:text-brand-600 dark:text-brand-dark-accent"
                )} />
                <input 
                  type="email"
                  required
                  ...
                  className={cn(
                    "w-full pl-10 pr-4 py-3.5 border rounded-xl transition-all font-medium",
                    !isCampusEmail 
                      ? "bg-slate-100 dark:bg-[#1E1E2F] border-slate-200 dark:border-[#3F3F5A]/30 text-slate-600 dark:text-slate-400 cursor-not-allowed" 
                      : "bg-slate-50 dark:bg-[#1E1E2F] border-slate-200 dark:border-[#3F3F5A]/30 focus:outline-none focus:ring-2 focus:ring-brand-500/50 focus:border-brand-500 text-slate-900 dark:text-[#F5F5F5]"
                  )}
